...
public class DaoFactoryImpl implements DaoFactory {
    private static final String FICHIER_PROPERTIES       = "/main/webapp/WEB-INF/dao.properties";
    ...
    public static DaoFactoryImpl getInstance() throws DAOConfigurationException {
        ...
        DaoFactoryImpl instance = new DaoFactoryImpl(url, nomUtilisateur, motDePasse );
        return instance;
    }
